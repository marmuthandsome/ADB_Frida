setTimeout(function() {
    Java.perform(function() {
        ...
        console.log('');
        console.log('=======================================================================');
        console.log('[#] Android Bypass for various Root and Certificate Pinning methods [#]');
        console.log('[#]                           YML and SH                            [#]');
        console.log('=======================================================================');
        console.log('');
        console.log('');
        ...
        console.log('');
        console.log('=======================================================================');
        console.log('[#]                       SSL Pinning Process                       [#]');
        console.log('=======================================================================');
        console.log('');
        console.log('');
